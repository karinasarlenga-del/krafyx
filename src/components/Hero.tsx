    ...
    <section id="hero" className="relative min-h-[90vh] w-full flex items-center overflow-hidden pt-20">
      ...
      <div className="relative z-20 px-6 md:px-16 w-full max-w-7xl mx-auto">
        <div className="max-w-4xl">
          <Reveal>
            <h1 className="font-montserrat text-4xl md:text-[48px] md:leading-[56px] tracking-tight font-semibold text-white mb-4">
              Historias que merecen ser vistas.<br/>
              <span className="opacity-80">Stories worth watching.</span>
            </h1>
          </Reveal>
          
          <Reveal delay={0.2}>
            <p className="font-inter text-lg text-white/90 mb-10 max-w-2xl leading-relaxed">
              Creamos comerciales audiovisuales que transforman marcas en experiencias memorables. / We create commercial films that turn brands into memorable experiences.
            </p>
          </Reveal>
